...
\begin{align}
  ...
  \rho(\eta) &\propto \exp\left(
               ...
               \right)\, .
\end{align}
The probability density $\pi(u|y_0,u_0,\mathcal{G})$ is what was called
$\pi^y(u)$ in Eq.~\ref{eq:BayesThmInversePosterior}. Hence, foe the Gaussian
case, Bayes' theorem yields
\begin{align}
