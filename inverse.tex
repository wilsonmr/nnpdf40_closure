...
These linear models may look at first sight like too much of a simplification.
In practice, it turns out that non-linear models can be linearised around the
central value of the prior distribution, 
\begin{equation}
  \label{eq:LinU0}
