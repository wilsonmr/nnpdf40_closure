...
In real-life cases we are interested in the posterior distribution of a set of
data that have not been included in the fit. In the Bayesian framework that we
have developed this can be modeled by having two sets of data $y$ and $y'$, for
which we have a prior distribution 
\begin{align}
  \label{eq:JointIndepDataPrior}
  \pi_D^0&\left(y,y'|y_0,y'_0,C_D,C'_D\right) 
...
\begin{equation}
  ...
  \pi(y,y',u) \propto \pi_D^0(y,y') \pi_M^0(u) 
