...
%In principle, the preprocessing
...
f%rom a predetermined range as is done in previous NNPDF releases, for example
%\cite{Ball_2017}. 
...
\begin{figure}
    \centering
    \includegraphics[width=0.8 \textwidth]{closure_input_gluon.pdf}
...
%From a practical standpoint, using the
...
%Furthermore, the data estimators only give us local
