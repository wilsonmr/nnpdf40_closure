...
L0, L1 and L2 that are obtained with the new methodology with the
corresponding ones obtained with the old framework. 
...
by looking at Fig.~\ref{fig:chi2_vs_epoch}, where we plot the distribution across replicas of the L0 closure test $\chi^2$
as a function of the training epoch and genetic algorithm generation
for the new and old methodology respectively. As mentioned before, in a L0
...
\begin{figure}[h]
    ...
    \caption{Relative PDF error for the gluon distribution in the new (upper panel)
    and old (lower panel) methodology, plotted in logarithmic (left) and linear scale (right).}
...
\begin{figure}[h]
    ...
    \caption{Level 0 uncertainty in the old and new methodology.}
...
\begin{figure}[h]
    ...
    epoch and genetic algorithm generation for the new (left) and old (right) methodology. The black dotted line
